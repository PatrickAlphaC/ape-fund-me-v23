...
def withdraw():
    ...
    self.funders = []
    # TODO: Test this on a multi-sig.
    # https://ethereum.stackexchange.com/questions/149307/does-vypers-send-function-have-the-same-issue-as-soliditys-transfer
...
def get_version() -> uint256:
    return self.price_feed.version()
